...
var app = express();
mongoose.connect('mongodb://mongod-0.mongodb-service,mongod-1.mongodb-service:27017/badReads',{auth: {"authSource": "admin"}, user: "admin", pass: "123456", useNewUrlParser: true, useUnifiedTopology: true });
